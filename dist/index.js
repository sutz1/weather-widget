...
const fetchData = async ()=>{
    try {
        ...
        const response = await (0, _axiosDefault.default).get(`https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&units=${(0, _credentials.UNITS)}&radar=true&appid=${(0, _credentials.API_KEY)}`);
...
updateWeather();
const intervalId = setInterval(updateWeather, 120000); // Clear interval when necessary (e.g., when the component is unmounted)
 // clearInterval(intervalId);

},{"./credentials":"ffpAH","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ffpAH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "API_KEY", ()=>API_KEY);
parcelHelpers.export(exports, "UNITS", ()=>UNITS);
const API_KEY = "238e0668ffd9bc840dfd3c6f0d09365b";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gmPuC","h7u1C"], "h7u1C", "parcelRequirebba3")
