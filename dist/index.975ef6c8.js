...
var credentials_1 = require("17a9118cb2844e2d");
var axios_1 = require("a4df52acf03d00cd");
var weather_icons_1 = require("2e36c0b5a0d8ae0e");
        ...
        return __generator(this, function(_a) {
            switch(_a.label){
                ...
                case 1:
                    ...
                    return [
                        4 /*yield*/ ,
                        axios_1.default.get("https://api.openweathermap.org/data/2.5/weather?lat=".concat(latitude, "&lon=").concat(longitude, "&units=").concat(credentials_1.UNITS, "&radar=true&appid=").concat(credentials_1.API_KEY))
                    ];
                case 2:
                    response = _a.sent();
                    return [
                ...
                case 1:
                    ...
                    if (weather) {
                        ...
                        if (icon) {
                            ...
                            console.log("Temperature:", Math.floor(weather.main.temp), "\xb0F");
                            console.log("Feels like:", Math.floor(weather.main.feels_like), "\xb0F");
                            ...
                            temperature.textContent = "Temperature: ".concat(Math.floor(weather.main.temp), " \xb0F");
...
},{"17a9118cb2844e2d":"4JnTb","a4df52acf03d00cd":"jo6P5","2e36c0b5a0d8ae0e":"jyvRM"}],"4JnTb":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.UNITS = exports.API_KEY = void 0;
exports.API_KEY = "238e0668ffd9bc840dfd3c6f0d09365b";
exports.UNITS = "imperial";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jyvRM":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.buildWeatherMap = void 0;
var CLOUDY = require("d73a067b01108e01");
var DAY = require("218a8ce69d58405b");
var PARTLY_CLOUDY = require("b9e484fcdcb14dea");
var RAIN = require("2b70c86ff9f91ae");
var LIGHT_RAIN = require("1d3f3e458280d7b9");
var THUNDERSTORM = require("7049f7daa881cc06");
var SNOW = require("7d74ff2b5b3db16c");
var UNKNOWN = require("54968d837512c4c4");
...
},{"d73a067b01108e01":"ak0eG","218a8ce69d58405b":"d1TwQ","b9e484fcdcb14dea":"lvNa3","2b70c86ff9f91ae":"f9Ldn","1d3f3e458280d7b9":"259EV","7049f7daa881cc06":"guqqL","7d74ff2b5b3db16c":"dXgaf","54968d837512c4c4":"8OB8I"}],"ak0eG":[function(require,module,exports) {
module.exports = require("d0a8f8b60fc2545e").getBundleURL("bLxZJ") + "cloudy.42c7e113.svg" + "?" + Date.now();

},{"d0a8f8b60fc2545e":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"d1TwQ":[function(require,module,exports) {
module.exports = require("7f648162c57a65d8").getBundleURL("bLxZJ") + "day.fbfbcf83.svg" + "?" + Date.now();

},{"7f648162c57a65d8":"lgJ39"}],"lvNa3":[function(require,module,exports) {
module.exports = require("cdb6764ccf215d4c").getBundleURL("bLxZJ") + "cloudy-day-3.22f9ec6b.svg" + "?" + Date.now();

},{"cdb6764ccf215d4c":"lgJ39"}],"f9Ldn":[function(require,module,exports) {
module.exports = require("385934c0a17505cd").getBundleURL("bLxZJ") + "rainy-6.f1293734.svg" + "?" + Date.now();

},{"385934c0a17505cd":"lgJ39"}],"259EV":[function(require,module,exports) {
module.exports = require("9acf7b3466d7d1b5").getBundleURL("bLxZJ") + "rainy-4.6db5397c.svg" + "?" + Date.now();

},{"9acf7b3466d7d1b5":"lgJ39"}],"guqqL":[function(require,module,exports) {
module.exports = require("91251286b63d56a0").getBundleURL("bLxZJ") + "thunder.cc385127.svg" + "?" + Date.now();

},{"91251286b63d56a0":"lgJ39"}],"dXgaf":[function(require,module,exports) {
module.exports = require("1fc5bd8028612f98").getBundleURL("bLxZJ") + "snowy-6.d6c86ffb.svg" + "?" + Date.now();

},{"1fc5bd8028612f98":"lgJ39"}],"8OB8I":[function(require,module,exports) {
module.exports = require("dfe594ce09fb1d6").getBundleURL("bLxZJ") + "Black_question_mark.1348023c.png" + "?" + Date.now();

},{"dfe594ce09fb1d6":"lgJ39"}]},["icZzK","8lqZg"], "8lqZg", "parcelRequirebba3")
